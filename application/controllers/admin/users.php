...
class Users extends MY_Controller
{
	...
	function create()
	{
		...
		$this->template->set('array_groups', group::find('all', array(
			'order' => 'name ASC'
		)));
	...
	function edit($id = FALSE)
	{
		...
		else
		{
			...
			if($this->input->post('group_id')){
				usersgroup::table()->delete(array(
					'user_id' => $user->id
				));
				usersgroup::create(array('user_id' => $user->id, 'group_id' => $this->input->post('group_id')));
			}
