<?php
class Floor_plan extends ActiveRecord\Model {
	...
	static function paginate_all($limit, $page)
	{
		...
		$result = Floor_plan::find('all', array('limit' => $limit, 'offset' => $offset, 'order' => 'id DESC' ) );
    ...
    private function process_item(&$item){
        if(!empty($item->floor_plan)){
            $url = '/public/uploads/floor_plans/files/' . $item->floor_plan;
